...
var updateCat = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var params_3, body_2, result_2;
...
var deleteCat = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var params_4, newCat;
    return __generator(this, function (_a) {
        try {
            params_4 = req.params;
            newCat = cats_model_1.Cat.filter(function (cat) { return cat.id !== params_4.id; });
            res.status(200).send({
                success: true,
                data: {
                    newCat: newCat
